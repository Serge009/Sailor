 ...
 * 
 */
@WebServiceClient(name = "ProductService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://78.188.182.81/LogoWebService/Services/ProductService.asmx?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://78.188.182.81/LogoWebService/Services/ProductService.asmx?WSDL");
     ...
     * 
     * @return
     *     returns ProductServiceSoap
     */
    @WebEndpoint(name = "ProductServiceSoap")
    public ProductServiceSoap getProductServiceSoap() {
        return super.getPort(new QName("http://tempuri.org/", "ProductServiceSoap"), ProductServiceSoap.class);
    }
     ...
     */
    @WebEndpoint(name = "ProductServiceSoap")
    public ProductServiceSoap getProductServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "ProductServiceSoap"), ProductServiceSoap.class, features);
    }
