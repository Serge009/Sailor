 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://78.188.182.81/LogoWebService/Services/LoginService.asmx?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://78.188.182.81/LogoWebService/Services/LoginService.asmx?WSDL");
    ...
    public LoginServiceSoap getLoginServiceSoap() {
        return super.getPort(new QName("http://tempuri.org/", "LoginServiceSoap"), LoginServiceSoap.class);
    }
    ...
    public LoginServiceSoap getLoginServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "LoginServiceSoap"), LoginServiceSoap.class, features);
    }
